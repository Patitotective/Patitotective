...
const data: seq[(string, seq[(string, Text)])] = @{
  "📦 Applications & Bots": @{
    "parabola": ("https://github.com/Patitotective/parabola",
      "projectile motion simulation (static) website"),
    "nimlangbot": ("https://github.com/Patitotective/nimlangbot",
        "twitter bot that retweets and likes nimlang related tweets"),
    "ImThemes": ("https://github.com/Patitotective/ImThemes",
        "dear imgui theme designer and browser"),
    "ImClocks": ("https://github.com/Patitotective/ImClocks",
        "dear imgui clocks application"),
    "ImPasswordGen": ("https://github.com/Patitotective/ImPasswordGen",
        "dear imgui random password generator application"),
    "ImTemplate": ("https://github.com/Patitotective/ImTemplate",
        "template for making a single-windowed dear imgui application"),
    "ImDemo": ("https://github.com/Patitotective/ImDemo",
        "dear imgui implementation of the 7GUIs tasks"),
  },
  "📙 Libraries": @{
    "kdl-nim": ("https://github.com/Patitotective/kdl-nim",
        "KDL document language nim implementation"),
    "downit": ("https://github.com/Patitotective/downit",
        "asynchronous downloads manager"),
    "ImStyle": ("https://github.com/Patitotective/ImStyle",
        "dear imgui styles manager"),
    "ImNotify": ("https://github.com/Patitotective/ImNotify",
        "dear imgui notifications"),
    "tinydialogs": ("https://github.com/Patitotective/tinydialogs",
        "tinyfiledialogs bindings for nim"),
    "minidocx-nim": ("https://github.com/Patitotective/minidocx-nim",
  ...
  "👨‍💻 About": @{
    ...
    "Patitotective#0127": ("https://discordapp.com/users/762008715162419261",
        "discord"),
    "Patitotective Open Source": ("https://discord.gg/U23ZQMsvwc",
        "discord server"),
  },
}
